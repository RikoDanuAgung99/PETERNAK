    ...
    public function store(Request $request)
    {
        ...
        try {
            $validated = $request->validate([
                ...
                'jml_bibit'     => 'required|numeric',
                'jml_kematian'  => 'required|numeric',
                'sisa_ayam'     => 'required|numeric',
                'deplesi'       => 'required|numeric|regex:/^\d+(\.\d{1,2})?$/',
                'std_deplesi'   => 'required|numeric|regex:/^\d+(\.\d{1,2})?$/',
                'total_panen'   => 'required|numeric',
                'tonase_panen'  => 'required|numeric',
                'rata_rata'     => 'required|numeric',
                'pakan'         => 'required|numeric',
                'std_pakan'     => 'required|numeric',
                'fcr'           => 'required|numeric|regex:/^\d+(\.\d{1,4})?$/',
                'std_fcr'       => 'required|numeric|regex:/^\d+(\.\d{1,4})?$/',
                'kandang_id'    => 'required|exists:kandang,id',

                'total_jumlah_bibit' => 'required|numeric',
                'harga_bibit_avg' => 'required|numeric',
                'total_harga_bibit' => 'required|numeric',

                'total_jumlah_pakan' => 'required|numeric',
                'harga_pakan_avg' => 'required|numeric',
                'total_harga_pakan' => 'required|numeric',

                'total_jumlah_obat' => 'required|numeric',
                'harga_obat_avg' => 'required|numeric',
                'total_harga_obat' => 'required|numeric',

                'total_jumlah_panen' => 'required|numeric',
                'total_tonase_panen' => 'required|numeric',
                'rata_rata_avg' => 'required|numeric',
                'harga_kontrak_avg' => 'required|numeric',
                'total_harga_panen' => 'required|numeric',

                'penjualan' => 'nullable|numeric',
                'pembelian' => 'nullable|numeric',
                'keuntungan_kerugian' => 'nullable|numeric',
