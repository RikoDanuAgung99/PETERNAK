        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title"><strong>TABEL DATA TRANSAKSI OBAT</strong></h2>
                    <div class="form-group float-right">
                        ...
                        @endif
                        <a href="{{ route('print.transaksiObat') }}" target="_blank" class="btn btn-success btn-md" id="print-stokObat"> Print
                            Obat</a>
                    </div>
                </div>
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        @if (auth()->user()->level === 'ADMIN' || auth()->user()->level === 'TS')
                                            <td class="text-center">
                                                ...
                                                <form action="{{ route('transaksiObat.destroy', $item->id) }}"
...
@push('js')
    <script type="text/javascript">
        $(document).ready(function() {
         ...
         $('#print-stokObat').click(function(e) {
            e.preventDefault();
            var kandangId = $('#kandang_id').val();
            var url = '{{ route('print.transaksiObat') }}';
            if (kandangId) {
